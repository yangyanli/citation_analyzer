            ...
            <div className="w-full max-w-md bg-white dark:bg-slate-900 border border-slate-200 dark:border-white/10 p-8 rounded-2xl shadow-xl flex flex-col gap-6">
                <div className="flex flex-col items-center gap-3">
                    ...
                    <h1 className="text-2xl font-bold text-slate-900 dark:text-white tracking-tight text-center">
                        Citation Analyzer Dashboard
                    </h1>
                    <p className="text-slate-600 dark:text-slate-400 text-sm">Sign in to manage citations and access advanced AI pipelines</p>
                </div>
                ...
                <div className="text-center mt-2 flex flex-col gap-2">
                    <p className="text-slate-600 dark:text-slate-400 text-sm">
                        ...
                        <Link href="/register" className="text-indigo-600 dark:text-indigo-400 hover:text-indigo-500 dark:hover:text-indigo-300 underline underline-offset-4 font-medium">
                            Register now
                        </Link>
                    </p>
